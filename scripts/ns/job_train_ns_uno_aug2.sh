...
export PYTHONPATH=$GINO_ENV_PATH/lib/python3.10/site-packages:$PYTHONPATH
...
$GINO_ENV_PATH/bin/python symmetry_no/train_ns.py --config config/ns/config_ns_uno_aug2.yaml
