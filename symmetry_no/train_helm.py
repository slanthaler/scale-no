...
def main(config):
    ...
    mlp = config.mlp if hasattr(config, 'mlp') else None
    scale_informed = config.scale_informed if hasattr(config, 'scale_informed') else None
    frequency_pos_emb = config.frequency_pos_emb if hasattr(config, 'frequency_pos_emb') else None
