...
class CNO(nn.Module):
    def __init__(self,
                 ...
                 latent_lift_proj_dim=32,  # Intermediate latent dimension in the lifting/projection layer
        ...
        if out_size == 1:
            ...
            if not expand_input:
                ...
                down_exponent = 2 ** N_layers
                latent_size_out = out_size - (
                            out_size % down_exponent) + down_exponent  # Jump from 64 to 72, for example
